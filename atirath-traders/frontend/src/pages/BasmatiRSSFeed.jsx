...
const BasmatiRSSFeed = () => {
  ...
  return (
    <div className="w-full h-16 bg-gradient-to-r from-black to-gray-900 border-b-2 border-yellow-600 shadow-lg z-30 overflow-hidden fixed top-14">
      <SEO 
        title="Live Rice Market Updates" 
        description="Real-time basmati rice market updates, prices, and global trade trends. Stay informed with live commodity intelligence."
        keywords="basmati prices live, rice market updates, agri-commodity trends, live rice trade"
      />
