 ...
 const API_BASE_URL = import.meta.env.VITE_API_BASE_URL;
  ...
  return (
    <div className="IndianAgriRSSFeed" style={{
      ...
      <SEO 
        title="Indian Agriculture & DGFT Updates" 
        description="Latest Indian agriculture news, DGFT policy updates, and government schemes for farmers and exporters. Live trade intelligence from Atirath Traders."
        keywords="dgft updates india, agriculture policy news, indian farming schemes, export trade news india"
      />
